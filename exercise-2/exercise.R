...
salary_employee57 <- salaries[salaries$employees == "Employee 57", "salaries_2018"]
...
name_highest_raise <- salaries[salaries$change == highest, "employees"]

# What was the largest decrease in salaries between the two years?
lowest <- min(salaries$change)

# What was the name of the employee who recieved largest decrease in salary?
name_lowest_raise <- salaries[salaries$change == lowest, "employees"]
